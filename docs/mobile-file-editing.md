...
可编辑扩展名由 `@omni-work/protocol-ts` 的 `SUPPORTED_TEXT_FILE_EXTENSIONS` 统一维护，App、Git 预览和 桌面端 Agent 共用同一套判断。当前范围包括常见源码、配置、日志、Markdown、CSV/TSV、HTML/CSS/SVG/XML/YAML/TOML/JSON 等文本文件。
